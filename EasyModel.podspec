#
#  Be sure to run `pod spec lint EasyModel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "EasyModel"
  s.version      = "0.0.1"
  s.summary      = "A short description of EasyModel."

  s.description  = <<-DESC
                   A longer description of EasyModel in Markdown format.
